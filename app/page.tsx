...
import Me from "@/public/hkbphoto2.png";

export default function Home() {
  return (
    <div className="divide-y divide-gray-100 dark:divide-gray-700">
      <div className="space-y-2 pt-5 pb-8 md:space-x-5">
        <h1 className="text-3xl text-center font-extrabold leading-9 tracking-tight text-gray-900 dark:text-gray-100 sm:text-4xl sm:leading-10 md:text-6xl md:leading-13">
          Welecom to my page!
        </h1>
      </div>
      ...
      <div className="items-center space-y-2 xl:grid xl:grid-cols-3 xl:gap-x-8 xl:space-y-0">
        <div className="flex flex-col items-center pt-8">
          ...
          <p className="text-gray-500 dark:text-gray-300 text-center">
            Hey my name is Harish and I am a Developer, Engineer
          </p>

          <div className="flex space-x-5 pt-6">
            <a href="https://github.com/hkbab123/" target="_blank">
              <svg
                viewBox="0 0 1024 1024"
                fill="currentColor"
                className="w-8 h-8 text-black-650 hover:text-red-600"
              >
            ...
            <a href="https://www.linkedin.com/in/harishbabry/" target="_blank">
              <svg
                viewBox="0 0 1024 1024"
                fill="currentColor"
                className="w-8 h-8 text-black-650 hover:text-red-600"
            ...
            <a href="hkbab123@hotmail.com" target="_blank">
              <svg
                viewBox="0 0 1024 1024"
                fill="currentColor"
                className="w-8 h-8 text-black-650 hover:text-red-600"
        ...
        <div className="prose max-w-none prose-lg pt-8 pb-7 dark:prose-invert xl:col-span-2">
          <p>
            Hey everyone my name is Harish, and i am a
            developer, Engineer based in UAE
          </p>
          <p>
